...
const wisataData = [
    {
        ...
        description:
            'Nikmati kesegaran dan keindahan air terjun tersembunyi yang menjadi primadona desa.',
    ...
    },
    {
        title: 'Bukit Harapan',
        description:
            'Saksikan pemandangan matahari terbit yang memukau dari puncak bukit dengan panorama desa.',
    ...
    },
    {
        ...
        description:
            'Jelajahi keindahan sawah terasering yang hijau dan menenangkan, khas pedesaan.',
                ...
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                    <div className="space-y-3">
                        ...
                        <p className="max-w-[900px] text-muted-foreground md:text-xl lg:text-2xl">
                            Temukan keindahan alam dan tempat-tempat menarik
                            yang ditawarkan oleh Desa Bautkan.
                        </p>
                    </div>
                </div>
