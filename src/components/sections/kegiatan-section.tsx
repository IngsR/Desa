...
const kegiatanData = [
    {
        ...
        description:
            'Setiap akhir pekan, warga bersama-sama membersihkan lingkungan untuk menjaga keasrian desa.',
    ...
    },
    {
        ...
        description:
            'Kegiatan keagamaan yang mempererat tali silaturahmi antar warga setiap malam Jumat.',
    ...
    },
    {
        title: 'Pasar Desa',
        description:
            'Pasar tradisional yang digelar setiap hari Minggu, menjadi pusat ekonomi dan interaksi sosial.',
                ...
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                    <div className="space-y-3">
                        ...
                        <p className="max-w-[900px] text-muted-foreground md:text-xl lg:text-2xl">
                            Melihat lebih dekat kegiatan rutin yang menjadi
                            denyut nadi kehidupan sosial di Desa Bautkan.
                        </p>
                    </div>
                </div>
