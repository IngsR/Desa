    ...
    return (
        <section className="w-full py-12 md:py-20 lg:py-24">
            <div className="container px-4 md:px-6">
                ...
                {/* Class 'max-w-5xl' dihapus agar peta lebih lebar */}
                <div className="mx-auto mt-10 md:mt-16">
                    <div className="rounded-lg bg-card text-card-foreground overflow-hidden shadow-lg border-2">
                        <div className="p-0">
                            <iframe
                                ...
                                title="Peta Lokasi Kecamatan Lubuk Begalung"
                            ></iframe>
                        </div>
                    </div>
                </div>
